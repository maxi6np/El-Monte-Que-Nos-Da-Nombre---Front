    ...
    const Ordenar = (condicion, array) => {
        switch (condicion) {
            ...
            case '%completada':
                ...
                array = [];
                porcentajes.forEach(ruta =>
                    array.push(ruta.ruta)
                )
                                        ...
                                        <Grid container spacing={2}>
                                            ...
                                            <Grid item xs={12} md={7}>
                                                ...
                                                <Typography variant="body" color="text.secondary">
                                                    ...
                                                    <p><DescriptionIcon /> Descripción: {ruta.descripcion.length > 250 ? `${ruta.descripcion.substring(0, 250)}...` : ruta.descripcion }</p>

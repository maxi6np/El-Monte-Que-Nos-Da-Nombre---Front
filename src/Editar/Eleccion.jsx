...
export default function Eleccion({ puntos, setPuntos, setChecked, checked }) {
...
useEffect(() => {
    setPuntos(puntos.map(punto => ({...punto, seleccionado: (checked.find(element=> element == punto.id_punto_interes) ? true : false)})));
}, [])
